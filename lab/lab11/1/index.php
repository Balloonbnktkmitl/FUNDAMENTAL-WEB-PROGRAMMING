...
<body>
    ...
    <form action="" method="post">
        ...
        <div>
            ...
            <button type="button" class="btn btn-info" name="showdatas" onclick="showdata('<?php echo $_SESSION['cusid']; ?>', '<?php echo $_SESSION['firstname']; ?>', '<?php echo $_SESSION['lastname']; ?>', '<?php echo $_SESSION['address']; ?>', '<?php echo $_SESSION['email']; ?>', '<?php echo $_SESSION['phone']; ?>')">Show Data</button>
